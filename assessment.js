...
// #2 Use the variable iLove to create a new variable called iLoveCode that is
//assigned the string "I love code"
var iLove = 'I love';
...
function coderTest(objPerson){
	if (objPerson.name === 'Jeremy'){
		objPerson.lovesCode = 10;
	} else if (objPerson.name === 'Brack'){
		objPerson.lovesCode = 0;
	} else {
		objPerson.lovesCode = 5;
	}
	return objPerson;
  }
...
*/
function outside(tempNum, humidNum, cloudNum){
	if (tempNum > 80 && humidNum > 40){
	  return "I'm all sweat";
	} else if (tempNum < 40 && cloudNum > 60){
	  return "I have icecicles";
	} else if (tempNum > 80 && humidNum < 40 && cloudNum < 20){
	  return "I'm literally in the desert";
	} else if (tempNum > 80 || humidNum > 50 || cloudNum > 50){
